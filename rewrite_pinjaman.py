...
new_parse = """def parse_baki_debet(val) -> float:
    ...
    try:
        ...
        try:
            ...
            return 0.0
"""
content = re.sub(r"def parse_baki_debet\(val\) -> float:.*?(?=def parse_numeric)", new_parse, content, flags=re.DOTALL)

# Replace get_pinjaman_value and build_pinjaman_rows
