...
# 1. Replace parse_baki_debet
new_parse = """def parse_baki_debet(val):
...
content = re.sub(r"def parse_baki_debet\(val\).*?return 0\.0", new_parse, content, flags=re.DOTALL, count=1)

# 2. Replace get_pinjaman_value and build_pinjaman_rows
